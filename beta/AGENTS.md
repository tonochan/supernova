...
- **他作品のゲーム名を、このリポジトリのコード・文言・コミット・Issue・宣伝に出さない**(着想元の検討経緯はオーナーのprivate KB側に記録されている。謝辞として載せる案はオーナー確認待ちの保留事項)
- 街・ビル・シティ等の用語は名前/コード/文言から排除済み(オーナー意向)。復活させない
...
- Aboutモーダル(着想元への謝辞+作者+GitHubリンク。文言はオーナー確認)
